...
LONG_TOPICS = [
    {"title": "Why Poor People Stay Poor (And Don't Know It)",
      "beats": [
          ("This morning, your salary hit your account. By tonight, most of it was already gone. Not to bills. To decisions you don't even remember making.", "phone_scroll", "Where did it go?"),
          ("Your brain already has an answer. I just don't earn enough. That's what everyone believes. For years, that was the official story.", "empty_wallet", "The official story"),
          ("Now look at two people. Same salary. Same city. Ravi and Aman. Ten years later, one has nothing. The other stopped worrying long ago. What split them?", "split_income", "Same salary. Split lives."),
          ("Aman did one boring thing. The day salary came, ten percent left first. Before rent. Before food. He paid himself like a bill.", "pay_first", "Pay yourself first"),
          ("Ravi laughed at the small amount. But small money, left alone, does something magical. It compounds while you sleep.", "compound", "Small money compounds"),
          ("Five years later, Ravi still lives salary to salary. Aman's money works nights and weekends. Same income. Different owner.", "compare", "Same income. Different owner."),
          ("Old mindset says look rich. New mindset says be free. They are opposite games. And you are already playing one of them.", "choice_forks", "Look rich vs be free"),
          ("Ravi bought things to impress people he doesn't like. Aman bought back his own time. One receipt fades. The other pays forever.", "buy_time", "Buy back your time"),
          ("Start today. Not with lakhs. With whatever is in your pocket right now. Direction beats amount. Every single time.", "start_now", "Start with pocket change"),
          ("Your bank statement is a diary. It remembers what your money did long after you forgot spending it. Slowly, then suddenly.", "bank_diary", "Slowly, then suddenly"),
      ]},
    {"title": "The 1 Habit That Separates Rich From Broke",
      "beats": [
          ("Tonight, open your banking app. Look at last month. That shock you feel? That is the most expensive feeling in the world. And almost nobody looks.", "phone_scroll", "Look at last month"),
          ("Two friends. Same job. Same salary. Ten years later, one is free and one is stuck. Your first guess is luck. It wasn't luck.", "split_income", "Same start. Different end."),
          ("The stuck one tracked spending in his head. Which means he never tracked it at all. Mental accounting always lies to its owner.", "empty_wallet", "Mental accounting lies"),
          ("The free one wrote down every rupee. Boring? Yes. Powerful? More than any salary hike he ever got.", "cheat_sheet", "Write every rupee"),
          ("Month one, he found three thousand leaking into food delivery. Month two, the leak closed. Awareness is the whole game.", "leak", "Find the leak"),
          ...
          ("His friend got two raises in ten years and has nothing to show. Raises feed lifestyle, not freedom. The data says the same everywhere.", "raise", "Raises feed lifestyle"),
          ("The habit takes nine minutes a day. Nine minutes between broke and free. That is the entire secret.", "clock_min", "Nine minutes a day"),
          ("Start tonight. Not tomorrow. Open the app. Look at the leak. That shock you feel is tuition, and it is cheap.", "start_now", "Feel the shock"),
    ...
    {"title": "Why Your Salary Is a Trap (And the Exit Door)",
     "beats": [
          ...
          ("A skill. A small product. A channel. Anything that earns while you sleep counts as one exit brick.", "brick", "One exit brick"),
          ...
          ("Never let one person control one hundred percent of your income. That is not a job. That is a leash with payslips.", "leash", "A job or a leash?"),
          ("Start with two hours after dinner. Not eight. Consistency beats intensity every single time. Boring wins.", "clock_min", "Two hours nightly"),
          ("In two years, his side income covered rent. In four, it covered the salary. Then he chose. The trap didn't open. He walked out.", "walk_away", "Then he chose"),
          ("The exit door was there all along. It was just hidden behind the television remote. Your evenings are the door.", "remote_door", "The door was always there"),
      ]},
]
...
SHORT_TOPICS = [
    ...
    {"title": "Why Budgeting Fails (And the One Page Fix)",
     "beats": [
          ...
          ("The red bar is the whole trick. When it appears, pick one thing to cut. Then one thing only.", "leak", "One cut"),
    ...
    {"title": "The Compound Path (Or Why Slow Wins the Race)",
     "beats": [
          ...
          ("Math punishes the fast. It rewards the stubborn. The fastest path is the slowest one.", "compare", "Slow is fast"),
